...
import * as StorePool_Ownable from "../contracts/StorePool_Ownable.sol";
...
contract StorePool_test {
    ...
    function checkSenderIs1 () public {
        /// sender: account-1
        Assert.equal(msg.sender, TestsAccounts.getAccount(2), "wrong sender in checkSenderIs1. It is not TestsAccounts.getAccount(2)");
        Assert.equal(msg.sender, TestsAccounts.getAccount(1), "wrong sender in checkSenderIs1 TestsAccounts.getAccount(1)");
    }
